...
# === Path ke model ===
model_paths = {
    "Model SVM": "/content/drive/MyDrive/Colab Notebooks/bpom_skincare/svm_model.joblib_fix",
    "Model SVM-ADASYN-PSO": "/content/drive/MyDrive/Colab Notebooks/bpom_skincare/svm_adasyn_pso.joblib_fix"
}
